...
@section('content')
    ...
    <div class="container mx-auto py-12 mt-14">
        <h1 class="text-4xl font-bold text-center underline-offset-2 text-blue-800 mb-12"> {{ $name ?? 'Your search Result' }}</h1>
                    ...
                    <div class="bg-white rounded-lg shadow-md hover:shadow-lg transform hover:scale-105 transition duration-300">
                        ...
                        <div class="p-5">
                            ...
                            <div class="flex justify-between items-center">
                               ...
                               <a href="{{route('login')}}"> <button class="bg-blue-600 text-white px-4 py-2 rounded-lg hover:bg-blue-700 transition duration-300">Book Now</button></a>
                            </div>
                        </div>
                    </div>
                    @endforeach
