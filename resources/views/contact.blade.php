...
<div class="grid md:grid-cols-2 gap-16 items-center relative overflow-hidden p-8 shadow-[0_2px_10px_-3px_rgba(6,81,237,0.3)] rounded-3xl max-w-6xl mx-auto bg-white mt-4 before:absolute before:right-0 before:w-[300px] before:bg-blue-400 before:h-full max-md:before:hidden">
    <div>
        ...
        <form>
            ...
            <a href="{{route('login')}}"><button type="button" class="mt-8 flex items-center justify-center text-sm font-semibold w-full rounded-md px-6 py-3 bg-blue-600 hover:bg-blue-700 text-white">
